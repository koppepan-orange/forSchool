...
function placeObject(object){
    ...
    if(typeof object.texture == "string"){
        let tex = textureLoader.load(`assets/textures/${object.texture}.png`);
        materials = [
        ...
        let texRight = textureLoader.load(`assets/textures/${object.texture.side}.png`);
        let texLeft = textureLoader.load(`assets/textures/${object.texture.side}.png`);
        let texTop = textureLoader.load(`assets/textures/${object.texture.top}.png`);
        let texBottom = textureLoader.load(`assets/textures/${object.texture.bottom}.png`);
        let texFront = textureLoader.load(`assets/textures/${object.texture.side}.png`);
        let texBack = textureLoader.load(`assets/textures/${object.texture.side}.png`);
        ...
        materials = [
            ...
            new THREE.MeshStandardMaterial({map: texBack})
        ];
    }
